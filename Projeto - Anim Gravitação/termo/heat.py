# EqHeat . py : solves heat equation via f ini t e differences , 3D plot
from numpy import *
...
for t in range(1,Nt):
	...
	if t%300 == 0 or t == 1: # Every 300 s teps
...
def functz (Tpl) :
	...
	return z
Z = functz(Tpl)
fig = p.figure(num=1, figsize = (12,12), dpi =200) # Create figure
colors = cm.viridis(Z)
ax = Axes3D(fig)
